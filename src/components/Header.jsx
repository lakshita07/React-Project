      ...
      <nav className="flex items-center justify-between flex-wrap bg-violet-600 py-4 px-6">
        ...
        <div className={isNavToggle ? navOpenClassName : navCloseClassName}>
          <div className="text-lg font-semibold lg:flex-grow" onClick={toggleClass}>
            <NavLink to="/home" className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
              Home
            </NavLink>
            <NavLink to="/about"  className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
              About Us
            </NavLink>
            <NavLink to="/contact"  className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
              Contact Us
            </NavLink>
            <NavLink to="/payment" className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
              Payment
            </NavLink>
            <NavLink to="/mydonations" className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
              My Donations
            </NavLink>
            </div>
            <div className="ml-auto">
            <NavLink to="/Login" className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
             Login
            </NavLink>
            <NavLink to="/SignUp" className={({ isActive }) => (isActive ? activeClassName : linkClassName)}>
              signup
            </NavLink>
          </div>
        </div>
